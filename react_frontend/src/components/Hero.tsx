...
function Hero() {
  return (
    <section className="landing-hero">
      {/* Video Background */}
      <video className="landing-video" autoPlay muted loop playsInline poster="/home/image.png">
      ...
      <div className="landing-content">
        ...
        <p>
          We Are a leading Best Hospital in Pokhara Providing 24/7 Emergency Services, ICU Care, Advanced
          Diagnostics, And Specialized Treatments With Experienced Doctors And Modern Technology.
        </p>
